...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>JVC - Email Konfirmasi</title>
              ...
              <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#232925">
                <tr>
                  ...
                  <td style="color: #ffffff;" class="header-text">
                    <br>
                    <br>
                    <span style="font-size: 24px;">Terima Kasih, Sudah mendaftarkan diri</span><br><br>
                    Akun JVC anda sudah siap, Aktifkan akun anda dengan klik tombol aktif.
                    <br>
                    <br>
                      <div><!--[if mso]>
                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:40px;v-text-anchor:middle;width:150px;" stroke="f" fillcolor="#2b934f">
                          ...
                          <center>
                        <![endif]-->
                            <a href="<?php echo base_url().'members/aktif/'.$id.'/'.$code ?>"
                        style="background-color:#2b934f;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Aktif</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                        <![endif]-->
                ...
                <tr>
                  <td>
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td>
                          <span class="header">Infromasi akun anda :</span><br>
                          Nama: <a href="#"><?php echo $nama; ?></a> <br>
                          Email: <a href="#"><?php echo $email; ?></a> <br>
                          Password: <a href="#"><?php echo $password; ?></a> <br><br>
